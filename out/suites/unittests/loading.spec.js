...
const testGenerateMinimalQueryList = async (t, expectations, result) => {
...
g.test('generateMinimalQueryList', async t => {
  await testGenerateMinimalQueryList(t, //
  [], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:foo:'], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:bar/buzz:'], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:baz:wye~'], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:wye~', 'suite1:baz:zed~']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:baz:zed~'], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:wye~', 'suite1:baz:zed~']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:baz:wye~', 'suite1:baz:zed~'], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:wye~', 'suite1:baz:zed~']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:baz:wye='], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:wye=', 'suite1:baz:wye={"x":1}', 'suite1:baz:zed~']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:baz:wye={"x":1}'], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:wye=', 'suite1:baz:wye={"x":1}', 'suite1:baz:zed~']);
  await testGenerateMinimalQueryList(t, //
  ['suite1:foo:', 'suite1:baz:wye='], ['suite1:foo:', 'suite1:bar/buzz:', 'suite1:baz:wye=', 'suite1:baz:wye={"x":1}', 'suite1:baz:zed~']);
});
